    ...
    en:
        {
            translation:
            {
                ...
                cardtitle1: 'Management book system',
                ...
                cardtitle2:'Tim Horton`s quality Analysis',
                ...
                cardtitle3:'Insurance Java Console Application',
                project3: 'Insurance Java Console Application, which allows the registration of customers, management of data, policies and claims.',
                cardtitle4:'',
                project4:'',
                cardtitle5:'',
                project5:'',
    ...
    pt:
        {
            translation:
            {
                ...
                cardtitle1: 'Sistema de gerenciamento de livros',
                ...
                cardtitle2: 'Análise de qualidade do Tim Horton`s',
                ...
                cardtitle3: 'Aplicativo de Console de Seguros em Java',
                project3: 'Aplicativo de Console de Seguros Java, que permite o cadastro de clientes, gerenciamento de dados, apólices e sinistros.',
                cardtitle4:'',
                project4:'',
                cardtitle5:'',
                project5:'',
    ...
    fr:
        {
            translation:
            {
                ...
                cardtitle2: 'Analyse de la qualité de Tim Horton`s',
                ...
                cardtitle3: 'Application de console d\'assurance Java',
                project3: 'Application de console d\'assurance Java, qui permet l\'enregistrement de clients, la gestion des données, les polices et les réclamations.',
                cardtitle4:'',
                project4:'',
                cardtitle5:'',
                project5:'',
    ...
    es:
        {
            translation:
            {
                ...
                cardtitle1: 'Sistema de gestión de libros',
                ...
                cardtitle2: 'Análisis de calidad de Tim Horton`s',
                ...
                cardtitle3: 'Aplicación de consola de seguros en Java',
                project3: 'Aplicación de consola de seguros en Java, que permite el registro de clientes, gestión de datos, pólizas y reclamaciones.',
                cardtitle4:'',
                project4:'',
                cardtitle5:'',
                project5:'',
